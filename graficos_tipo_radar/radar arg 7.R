...
arg7 <- data %>%
  ...
  scale_fill_manual(values = c("#b5e2fa", "#f77f00", "yellow", "#3a0ca3")) +
  scale_color_manual(values = c("#b5e2fa", "#f77f00", "#fcbf49", "#3a0ca3"))+ theme(legend.position = "none")



arg7
# se quiser salvar
saveRDS(arg7, file = "C:/Users/grego/OneDrive/Desktop/work/SCRIPTS TALK ABOUT/WVS/WVS confirmatoria/radar grafic/arg7.rds")
