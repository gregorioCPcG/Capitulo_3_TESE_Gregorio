#rodar urug5(em scripts primeiro)
library(poorman)
library(datawizard)
library(easystats)
# urug5entina - testar primeiro
df %>% glimpse()
...
urug55<- data %>%
  ...
  scale_fill_manual(values = c("#f77f00","#fb6f92", "darkblue" )) +
  scale_color_manual(values = c("#f77f00","#fb6f92", "darkblue"))+ theme(legend.position = "none")


urug55
# se quiser salvar
saveRDS(urug55, file = "C:/Users/grego/OneDrive/Desktop/work/SCRIPTS TALK ABOUT/WVS/WVS confirmatoria/radar grafic/urug5.rds")
