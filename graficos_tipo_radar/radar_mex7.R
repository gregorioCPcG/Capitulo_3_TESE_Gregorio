#rodar mex7(em scripts primeiro)
library(poorman)
library(datawizard)
library(easystats)
...
mex7<- data %>%
  ...
  scale_fill_manual(values = c("#ff595e","darkblue","gold","#6a994e")) +
  scale_color_manual(values = c("#ff595e","darkblue","gold","#6a994e"))+ theme(legend.position = "none")


mex7
# se quiser salvar
saveRDS(mex7, file = "C:/Users/grego/OneDrive/Desktop/work/SCRIPTS TALK ABOUT/WVS/WVS confirmatoria/radar grafic/mex7.rds")
