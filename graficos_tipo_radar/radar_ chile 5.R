#rodar chile5(em scripts primeiro)
library(poorman)
library(datawizard)
library(easystats)
...
chile5
# se quiser salvar
saveRDS(chile5, file = "C:/Users/grego/OneDrive/Desktop/work/SCRIPTS TALK ABOUT/WVS/WVS confirmatoria/radar grafic/chile5.rds")
