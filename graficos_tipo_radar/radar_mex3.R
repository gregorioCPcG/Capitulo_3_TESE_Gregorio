#rodar mex3(em scripts primeiro)
library(poorman)
library(datawizard)
library(easystats)
...
mex3<- data %>%
  ...
  scale_fill_manual(values = c("darkblue","gold","#6a994e","#ff595e")) +
  scale_color_manual(values = c("darkblue","gold","#6a994e","#ff595e"))+ theme(legend.position = "none")


mex3
# se quiser salvar
saveRDS(mex3, file = "C:/Users/grego/OneDrive/Desktop/work/SCRIPTS TALK ABOUT/WVS/WVS confirmatoria/radar grafic/mex3.rds")
