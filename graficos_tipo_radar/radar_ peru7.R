#rodar peru7(em scripts primeiro)
library(poorman)
library(datawizard)
library(easystats)
...
peru7<- data %>%
  ...
  scale_fill_manual(values = c("#b392ac", "cyan" )) +
  scale_color_manual(values = c("#b392ac", "cyan"))+ theme(legend.position = "none")


peru7
# se quiser salvar
saveRDS(peru7, file = "C:/Users/grego/OneDrive/Desktop/work/SCRIPTS TALK ABOUT/WVS/WVS confirmatoria/radar grafic/peru7.rds")
