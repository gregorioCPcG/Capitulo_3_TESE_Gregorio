...
recode_rules <- c("Catholic" = "Católica",
                  "Other Christian (Evangelical/Pentecostal)" = "Evangélica",
                  "Do not belong to a denomination" = "Nenhuma",
                  "Others" = "Outras religiões")

# Recodifique todos 
df$religion <- recode(df$religion, !!!recode_rules)
