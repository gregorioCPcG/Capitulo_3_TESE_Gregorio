...
logitPRI__3 <- glm(PRI_~autoloc_dir_esq+interesse+
                     ...
                     desconfia,data = df, family=binomial(link=logit))
logitPRI__4 <- glm(PRI_~Gender+X049+region+
                     idade_faixa+escolaridade_niveis+
