...
#valors~partido
fundamentalism1 <- lm(fundamentalism ~ P17_recod 
                      , data=df)
r<-summary(fundamentalism1)
r$adj.r.squared

antidemocr1 <- lm(antidemocr~ P17_recod
                  , data=df)
r<-summary(antidemocr1)
r$adj.r.squared
promercado1 <- lm(promercado ~ P17_recod
                  , data=df)
...
#valores ~estrutr
fundamentalism2 <- lm(fundamentalism ~ Mulher+
...
antidemocr2 <- lm(antidemocr~ Mulher+
                    faixa_etaria+Escolaridade+
                    perfilProfissional+Renda+semReligiao
                  , data=df)
r<-summary(antidemocr2)
r$adj.r.squared
promercado2 <- lm(promercado ~ Mulher+
                    faixa_etaria+Escolaridade+
                    perfilProfissional+Renda+semReligiao
                  , data=df)
